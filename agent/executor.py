...
def _call_tool(tool: str, parameters: dict, speak: Callable | None) -> str:
    ...
    if tool == "open_app":
        ...
        return web_search_action(parameters=parameters, player=None) or "Done."
        ...
        return file_processor(parameters=parameters, player=None, speak=speak) or "Done."
        ...
        # Fallback: try web_search with the goal
        fallback_params = {"query": str(parameters.get("description", parameters))}
        from actions.web_search import web_search as web_search_action
        return web_search_action(parameters=fallback_params, player=None) or "Done."
